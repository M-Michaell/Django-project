...
class Campaign(models.Model):
    ...
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, default=None, related_name="campaign"
    )
...
class Donation(models.Model):
    ...
    project = models.ForeignKey(
        Campaign, on_delete=models.CASCADE, related_name="donation"
    )
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="donation"
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class Comment_Report(models.Model):
    user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="comment_report"
    )
    report_category = [
        ("1", "Flase Information"),
        ("2", "Violenece"),
